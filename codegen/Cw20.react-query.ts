...
export const cw20QueryKeys = {
  ...
  allSpenderAllowances: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cw20QueryKeys.address(contractAddress)[0],
...
export function useCw20AllSpenderAllowancesQuery<TData = AllSpenderAllowancesResponse>({
  ...
  return useQuery<AllSpenderAllowancesResponse, Error, TData>(cw20QueryKeys.allSpenderAllowances(client?.contractAddress, args), () => client ? client.allSpenderAllowances({
    limit: args.limit,
    spender: args.spender,
    startAfter: args.startAfter
  }) : Promise.reject(new Error("Invalid client")), { ...options,
