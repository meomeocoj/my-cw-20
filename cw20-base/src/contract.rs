...
use crate::state::{MinterData, TokenInfo, ALLOWANCES, ALLOWANCES_SPENDER, BALANCES, TOKEN_INFO};
...
mod tests {
    ...
    mod migration {
        ...
        use cw20::{
            AllAllowancesResponse, AllSpenderAllowancesResponse, Expiration, SpenderAllowanceInfo,
        };
